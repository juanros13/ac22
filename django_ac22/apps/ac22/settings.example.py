...
TEMPLATES = [
    {
        ...
        'DIRS': [
        '/home/user/ac22/django_ac22/ac22/templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = '/home/user/ac22/static'

DOMAIN_NAME = 'ac22.juanros13.com'

KEY_STRING = 'a3s1jkn1itw.2567edahrtasda61d6aas889q8we9qyjyth'
...
EMAIL_PORT = 587
DEFAULT_EMAIL_FROM = 'xxx@gmail.com'

MEDIA_ROOT = "/home/user/ac22/media"
